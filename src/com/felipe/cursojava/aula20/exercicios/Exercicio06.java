...
public class Exercicio06 {
	...
	public static void main(String[] args) {
		...
		while(!ganhou) {
			...
			// Enquanto isso aqui for falso ele continua repetidno.. quando deixará de ser falso? Quando a condição do if for atendida.
			// Enquanto essa boolean não for true, ou seja, não entrar no if, ele repete.
			while(!linhaValida) {
